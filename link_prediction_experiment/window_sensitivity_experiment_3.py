...
def compute_window_durations(
    ...
    divisors = np.linspace(window_divisor_start, window_divisor_end, num_steps)
...
def main():
    ...
    parser.add_argument(
        ...
        type=int,
        default=1,
        help='Smallest window = T / window_divisor_start (default: 1)'
    )
    parser.add_argument(
        '--num_window_steps',
        type=int,
    ...
    results = run_window_sensitivity_experiment(
        ...
        window_divisor_end=args.window_divisor_end,
